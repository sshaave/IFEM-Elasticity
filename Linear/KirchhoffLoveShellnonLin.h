...
class KirchhoffLoveShellnonLin : public KirchhoffLove
{
public:
  //! \brief Default constructor.
  KirchhoffLoveShellnonLin();
  //! \brief Empty destructor,
  virtual ~KirchhoffLoveShellnonLin() {}
...
protected:
  ...
  bool formBmatrix(Matrix& dE_ca, Matrix& dK_ca,
                   Matrix3D ddE_ca, Matrix3D ddK_ca,
                   ,Vec3& E_ca, Vec3& K_ca,const FiniteElement& fe) const;
